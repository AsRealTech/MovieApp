                                ...
                                <div className="col-lg-8 col-md-8">
                                    ...
                                    <div className="anime__details__form">
                                        ...
                                        <form onSubmit={handleReviewSubmit}>
                                            <textarea placeholder="Your Comment" value={reviewText} onChange={e => setReviewText(e.target.value)} required></textarea>
                                            <div className="mt-2">
                                                <label className="text-primary">Rating: </label>
                                                <input type="number" min="0" max="10" value={reviewRating} onChange={e => setReviewRating(Number(e.target.value))} required style={{width: '60px', marginLeft: '10px'}} />
                                            </div>
